...
class TestDoubleExponentialSmoothingStream(unittest.TestCase):
    ...
    def test_normal_case_return_ok(self):
        ...
        smoothing_stream = DoubleExponentialSmoothingStream(np.array([1, 2, 3]), alpha=0.4, beta=0.1)
    ...
    def test_one_observation_returns_2D(self):
        ...
        smoothing_stream = DoubleExponentialSmoothingStream(np.array([1, 2]), alpha=0.4, beta=0.1)
        smoothing_stream.smooth_frame(observation)
        result = smoothing_stream.get_last_smoothed_frame()
        np.testing.assert_allclose(result, expected_result)
    ...
    def test_alpha_zero_returns_first(self):
        ...
        smoothing_stream = DoubleExponentialSmoothingStream(np.array([1, 2, 3]), alpha=0, beta=0.1)
        smoothing_stream.smooth_frame(observation)
        result = smoothing_stream.get_last_smoothed_frame()
        np.testing.assert_allclose(result, expected_result)
    ...
    def test_alpha_one_beta_one_return_plus_one(self):
        ...
        smoothing_stream = DoubleExponentialSmoothingStream(np.array([1, 2, 3]), alpha=1, beta=1)
        smoothing_stream.smooth_frame(observation)
        result = smoothing_stream.get_last_smoothed_frame()
        np.testing.assert_allclose(result, expected_result)
    ...
    def test_alpha_one_beta_0_1_return_plus_one(self):
        ...
        smoothing_stream = DoubleExponentialSmoothingStream(np.array([1, 2, 3]), alpha=1, beta=0.1)
        smoothing_stream.smooth_frame(observation)
        result = smoothing_stream.get_last_smoothed_frame()
        np.testing.assert_allclose(result, expected_result)
